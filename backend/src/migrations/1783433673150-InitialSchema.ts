...
export class InitialSchema1783433673150 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_e814453dd9419be9fe450f0805" ON "pr_events" ("prId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_612a08fe14b461f989e838c1a5" ON "pr_events" ("occurredAt") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_23bc8f04b8e5b5b5ba801782db" ON "pr_events" ("externalId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_589c74fad37545745986ba01e5" ON "pull_requests" ("repo") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0065c7041322f3ee107ec92b60" ON "pull_requests" ("authorLogin") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_2e9d54ccbbf76cda98779d89ad" ON "people" ("githubLogin") WHERE "githubLogin" IS NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "pr_events" ADD CONSTRAINT "FK_e814453dd9419be9fe450f0805a" FOREIGN KEY ("prId") REFERENCES "pull_requests"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "pr_events" DROP CONSTRAINT "FK_e814453dd9419be9fe450f0805a"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2e9d54ccbbf76cda98779d89ad"`,
    );
    await queryRunner.query(`DROP TABLE "people"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0065c7041322f3ee107ec92b60"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_589c74fad37545745986ba01e5"`,
    );
    await queryRunner.query(`DROP TABLE "pull_requests"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_23bc8f04b8e5b5b5ba801782db"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_612a08fe14b461f989e838c1a5"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e814453dd9419be9fe450f0805"`,
    );
